...
for epochs in [5, 10, 15, 20, 30, 50, 100, ]:
    print('Begin training for model1, epochs = ', epochs, '...')
    ...
    filepath = './model1/'+str(epochs)+'.save'
    # Plot validation
    if True:
        fig, ax = None, None
        for row in range(10):
    ...
    keras.models.save_model(models[imodel], filepath)
    imodel += 1
